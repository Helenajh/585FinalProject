...
In this section, we were interested how the house sale price changes at different location. On overall average of sale price in story county in 2016 was \$180K - \$190K. It located near Grand Avenue, 13 street and 24 street and near Ontario street as well. We noticed that the highest house sale on average was tent to centered near the northridge heights park area in 2016 (Fig. \ref{fig:price63}). What's more, for most of those houses with high saling prices were mostly recently built (the median built year for house with saling prices greater than \$300K were 2003).  
